        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="<?php echo site_url();?>/s/about_us"><p class="menu-sty">About Us</p></a>
                    </li>
                    <li>
                        <a href="<?php echo site_url();?>/nathantraders/areas_we_serve"><p class="menu-sty">Areas We Serve</p></a>
                    </li>
                    <li>
